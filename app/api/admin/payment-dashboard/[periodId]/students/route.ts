...
// GET /api/admin/payment-dashboard/[periodId]/students - Obtener estudiantes con formularios de pago
export async function GET(
  ...
  try {
    ...
    const students = await monthlyPaymentService.getStudentsWithPaymentForms(periodId, {
      page,
      limit,
      search
    });
