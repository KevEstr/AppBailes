...
/**
 * Script para generar sesiones automáticamente
 * Este script se ejecuta como cron job en Railway
 */
...
// Configuración
const API_URL = process.env.RAILWAY_PUBLIC_DOMAIN || 'http://localhost:3000';
