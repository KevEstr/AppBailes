...
import { Settings, Plus, Edit2, DollarSign, Calendar, Users, Activity } from 'lucide-react';
        ...
        <Dialog open={showCreateDialog} onOpenChange={setShowCreateDialog}>
          ...
          <DialogContent className="bg-gray-800 border-gray-600 text-white">
            ...
            <div className="space-y-4">
              ...
              <div>
                <Label htmlFor="basePrice" className="text-white">Precio Base</Label>
                <Input
                  id="basePrice"
                  type="number"
                  placeholder="0.00"
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
        ...
        <TabsContent value="services" className="space-y-4">
          <div className="grid gap-6">
            {services.map((service) => (
              <Card key={service.id} className="border-0 bg-gray-800/90 shadow-2xl backdrop-blur-sm border border-gray-600">
                <CardHeader>
                  <div className="flex items-center justify-between">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                    <div className="bg-gray-700/50 rounded-lg p-4">
                      <div className="flex items-center space-x-2">
                        ...
                        <span className="text-gray-300 text-sm">Precio Base</span>
                      </div>
              ...
              <Card className="border-0 bg-gray-800/90 shadow-2xl backdrop-blur-sm border border-gray-600">
                <CardContent className="py-12">
                  <div className="text-center">
                    ...
                    <h3 className="text-white text-lg font-semibold mb-2">No hay servicios creados</h3>
                    <p className="text-gray-400 mb-6">Crea tu primer servicio adicional</p>
                    <Button 
        ...
        <TabsContent value="orders" className="space-y-4">
          <div className="grid gap-4">
            {orders.map((order) => (
              <Card key={order.id} className="border-0 bg-gray-800/90 shadow-2xl backdrop-blur-sm border border-gray-600">
                <CardContent className="p-6">
                  <div className="flex items-center justify-between mb-4">
                    <div className="flex items-center space-x-3">
                      <h3 className="text-white font-semibold">{order.service.name}</h3>
                      {getStatusBadge(order.status)}
                    </div>
                    <div className="text-right">
                      <p className="text-white font-bold text-lg">{formatCurrency(order.totalAmount)}</p>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div>
                      ...
                      <p className="text-gray-400 text-xs">{order.student.phone}</p>
                    </div>
                    <div>
                      <p className="text-gray-400 text-sm">Cantidad</p>
                      <p className="text-white font-medium">{order.quantity} x {formatCurrency(order.unitPrice)}</p>
                    </div>
                    <div>
              ...
              <Card className="border-0 bg-gray-800/90 shadow-2xl backdrop-blur-sm border border-gray-600">
                <CardContent className="py-12">
                  <div className="text-center">
                    ...
                    <h3 className="text-white text-lg font-semibold mb-2">No hay órdenes de servicios</h3>
                    <p className="text-gray-400">Las órdenes aparecerán aquí cuando se creen</p>
                  </div>
                </CardContent>
              </Card>
            )}
