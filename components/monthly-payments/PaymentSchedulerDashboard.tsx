            ...
            <Card key={scheduler.id} className="bg-gray-800 border-gray-700">
              ...
              <CardContent className="pt-0">
                ...
                <div className="grid grid-cols-2 lg:grid-cols-5 gap-3 md:gap-4 mb-4">
                  ...
                  <div className="text-center bg-gray-700/20 p-3 rounded">
                    <p className="text-xs md:text-sm text-gray-400 mb-1">Destinatarios</p>
                    <p className="text-white text-xs md:text-sm font-medium break-words">
                          ...
                          <div key={execution.id} className="bg-gray-700 rounded p-3">
                            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 mb-2">
                              ...
                              <div className="flex items-center gap-3 text-xs md:text-sm">
                                ...
                                <Badge className={`${successRate >= 80 ? 'bg-green-500' : successRate >= 50 ? 'bg-yellow-500' : 'bg-red-500'}`}>
                                  {successRate}% éxito
                                </Badge>
                              </div>
                            </div>
