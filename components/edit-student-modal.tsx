        ...
        try {
          ...
          if (data.success && data.student) {
            const fullStudentData = {
              ...
              documentType:
                mapDocumentTypeToCode(
                  data.student.enrollmentData?.documentType
                ) || "CC",
              birthDate: data.student.enrollmentData?.birthDate || "",
              address: data.student.enrollmentData?.address || "",
              addressLatitude:
                data.student.enrollmentData?.addressLatitude || 0,
              addressLongitude:
                data.student.enrollmentData?.addressLongitude || 0,
              ...
              hasRestrictions:
                data.student.enrollmentData?.hasRestrictions || false,
              restrictionsDescription:
                data.student.enrollmentData?.restrictionsDescription || "",
              medicalConditions:
                data.student.enrollmentData?.medicalConditions || "",
              isAdult:
                data.student.enrollmentData?.isAdult !== undefined
                  ? data.student.enrollmentData.isAdult
                  : true,
              emergencyContactName:
                data.student.enrollmentData?.emergencyContactName || "",
              emergencyContactRelation:
                mapRelationshipToCode(
                  data.student.enrollmentData?.emergencyContactRelation
                ) || "",
              emergencyContactPhone:
                data.student.enrollmentData?.emergencyContactPhone || "",
              guardianName: data.student.enrollmentData?.guardianName || "",
              guardianRelation:
                mapRelationshipToCode(
                  data.student.enrollmentData?.guardianRelation
                ) || "",
