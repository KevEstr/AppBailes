  ...
  const calculatedAmounts = useMemo(() => {
    ...
    const discount =
      formData.promotion !== "none"
        ? getPromotionDiscount(formData.promotion)
        : 0;
        ...
        <CardContent className="p-6 sm:p-8">
          ...
          <div className="space-y-4 text-gray-300">
            <div className="grid grid-cols-2 gap-6">
              <div>
                <p>
                  <strong className="text-white">Estudiante:</strong>{" "}
                  {formData.studentName || "No especificado"}
                </p>
                <p>
                  <strong className="text-white">Cédula:</strong>{" "}
                  {formData.studentId || "No especificado"}
                </p>
                <p>
              ...
              <div>
                <p>
                  <strong className="text-white">Concepto:</strong>{" "}
                  {formData.concept || "No especificado"}
                </p>
                <p>
                  <strong className="text-white">Método:</strong>{" "}
                  {formData.paymentMethod || "No especificado"}
                </p>
                <p>
            ...
            <div className="bg-gray-700/50 p-6 rounded-2xl border border-gray-600">
              <div className="flex justify-between items-center text-lg mb-2">
                ...
                <span className="text-white">
                  ${calculatedAmounts.amount.toLocaleString()}
                </span>
              </div>
              {formData.promotion !== "none" && (
                <div className="flex justify-between items-center text-lg mb-2">
              ...
              <div className="border-t border-gray-600 pt-2">
                <div className="flex justify-between items-center text-xl font-bold">
                  ...
                  <span className="text-blue-400">
                    ${calculatedAmounts.finalAmount.toLocaleString()}
                  </span>
                </div>
              </div>
              {formData.promotion !== "none" && (
                <Badge className="bg-purple-600 text-white mt-2">
                  Promoción aplicada: {getPromotionDiscount(formData.promotion)}
                  % descuento
                </Badge>
              )}
            </div>
